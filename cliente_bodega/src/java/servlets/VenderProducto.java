 ...
 * @author usuario1
 */
@WebServlet(name = "VenderProducto", urlPatterns = {"/VenderProducto"})
public class VenderProducto extends HttpServlet {

    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/servicio_bodega/Vender.wsdl")
    private Vender_Service service;
    ...
    public String venderProducto(java.lang.String producto, java.lang.String bodega, int cantidad) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        webservice.Vender port = service.getVenderPort();
